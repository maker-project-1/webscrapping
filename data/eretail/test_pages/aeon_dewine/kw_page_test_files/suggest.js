...
Suggest.Local.prototype = {
  ...
  onSelect:function(index){}, // 選択したときに呼び出される。
...
//alert(i+'/'+j+':'+value[i] +','+pattern[j]+','+found);
//					pos[j] = found;
...
//			       + '</strong>' + this._escapeHTML(value[0].substr(pos + pattern[0].length)));
			// ↓修正。
