...
(function ($)
{
    ...
    {
        var strUA = navigator.userAgent.toLowerCase(), webkitUA = ['iphone', 'android', 'ipad'], runiLayout = false, 
        iLayoutLocation = '', currentX = 0, maxX = 0, slideObj = {}, slideLock = 1, slideTimer = {},
        slideLotation = {}, slideDuration = 4000, slideCount = 0, pagerMax = 0, orientationChangeDelay = 0;
        ...
        function orientationChangeCore()
        {
            ...
            setTimeout(function ()
            {
                ...
                if (styles)
                {
                    ...
                    maxX = Number($('.flickSlideContainer li.slideUnit').length - 1) * Number(styles.width.replace('px', 
                    '')) *- 1;
        ...
        var settings = $.extend({
            target : '', colum : 1, height : 170, duration : 4000
        }, settings);
        var contents = $(this);
...
(function ($)
{
    $.fn.onlyflick = function (settings)
    {
        var strUA = navigator.userAgent.toLowerCase(), webkitUA = ['iphone', 'android', 'ipad'], runiLayout = false, 
        iLayoutLocation = '', currentX = 0, maxX = 0, slideObj = {}, slideLock = 1, slideTimer = {},
        slideLotation = {}, slideDuration = 600000, slideCount = 0, pagerMax = 0, orientationChangeDelay = 0;
        for (var i = 0; i < webkitUA.length; i++)
        {
            if (strUA.indexOf(webkitUA[i], 0) !=- 1)
            {
