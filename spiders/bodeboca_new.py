...
def ctg_parsing(fpath, ctg, categories, products):  # TODO : modify xpaths
    ...
    for li in tree.xpath('//div[@id="venta-main"]/div'):
        ...
        products[produrl] = {
            ...
            'raw_price': clean_xpathd_text(li.xpath('.//div[@class="wineblock-leftprice"]//*[@class="uc-price"]//text()')),
            'raw_promo_price': clean_xpathd_text(li.xpath('.//div[@class="wineblock-price-rightcol"]//*[@class="uc-price"]//text()')),
...
def kw_parsing(fpath, kw, searches, products):  # TODO : modify xpaths
    ...
    for li in tree.xpath('//div[@id="search-results-main"]/div'):
        ...
        products[produrl] = {
            ...
            'raw_promo_price': clean_xpathd_text(li.xpath('.//div[@class="wineblock-price-rightcol"]//*[@class="uc-price"]//text()')),
            'pdct_img_main_url': "".join(li.xpath('.//xpath')[:1]),
        }
        products[produrl]['brnd'] = brm.find_brand(products[produrl]['pdct_name_on_eretailer'])['brand']
        print(products[produrl], produrl)
        products[produrl]['price'] = getprice(products[produrl]['raw_price'])
...
def pdct_parsing(fpath, url, products): # TODO : modify xpaths
    ...
    products[url].update({
        'volume': clean_xpathd_text(tree.xpath('//*[@id="main-section"]//*[@class="formato"]/text()')[:3], unicodedata_normalize=True),
...
kw_search_url = "https://www.bodeboca.com/"  # TODO : modify URL
for kw in keywords:
    searches[kw] = []
