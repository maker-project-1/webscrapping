...
shop_id = 'drink_supermarket'
root_url = 'https://www.drinksupermarket.com/'
...
# # CTG page xpathing #
# ##################
ctg_page_test_url = 'https://www.drinksupermarket.com/champagne'
...
def ctg_parsing(fpath, ctg, categories, products):  # TODO : modify xpaths
    ...
    for li in tree.xpath('//ul[contains(@id ,"product_list")]/li'):
        ...
        products[produrl] = {
            'pdct_name_on_eretailer': clean_xpathd_text(li.xpath('.//h2[@class="product-name"]//text()')),
            'volume': clean_xpathd_text(li.xpath('.//h2[@class="product-name"]//text()')),
...
# # KW page xpathing #
###################
search_page_test_url = 'https://www.drinksupermarket.com/champagne-sparkling'
...
urls_ctgs_dict = {
    'whisky': 'https://www.drinksupermarket.com/whisky?limit=60&p={page}',
    'champagne': 'https://www.drinksupermarket.com/champagne?limit=60&p={page}',
    'cognac': 'https://www.drinksupermarket.com/cognac?limit=60&p={page}',
    'sparkling': 'https://www.drinksupermarket.com/sparkling-wine?limit=60&p={page}',
    'vodka': 'https://www.drinksupermarket.com/vodka?limit=60&p={page}',
    'still_wines': 'https://www.drinksupermarket.com/wines?limit=60&p={page}',
    'gin': 'https://www.drinksupermarket.com/gin?limit=60&p={page}',
    'tequila': 'https://www.drinksupermarket.com/tequila?limit=60&p={page}',
    'red_wine': 'https://www.drinksupermarket.com/red-wine?limit=60&p={page}',
    'white_wine': 'https://www.drinksupermarket.com/white-wine?limit=60&p={page}',
    'rum': 'https://www.drinksupermarket.com/rum?limit=60&p={page}',
#    'bourbon': 'https://www.drinksupermarket.com/?limit=60&p={page}',
    'brandy': 'https://www.drinksupermarket.com/brandy-jerez?limit=60&p={page}',
    'liquor': 'https://www.drinksupermarket.com/liqueurs?limit=60&p={page}'
}
...
kw_search_url = "https://www.drinksupermarket.com/catalogsearch/result/?q={kw}"  # TODO : modify URL
for kw in keywords:
    searches[kw] = []
