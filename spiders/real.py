...
# # CTG page xpathing #
# ##################
ctg_page_test_url = 'https://www.real.de/category/6581/p1'
...
def ctg_parsing(fpath, ctg, categories, products):  # TODO : modify xpaths
    ...
    for li in tree.xpath('//div[contains(@class, "widget item product")]'):
        ...
        products[produrl] = {
            'pdct_name_on_eretailer': clean_xpathd_text(li.xpath('.//div[@class="_title"]//text()')),
            'volume': clean_xpathd_text(li.xpath('.//div[@class="_title"]//text()')),
            'raw_price': clean_xpathd_text(li.xpath('(.//div[@class="_price-wrapper"]//text())[1]')) + clean_xpathd_text(li.xpath('(.//div[@class="_price-wrapper"]/div/@data-cents)[1]')),
            'raw_promo_price': clean_xpathd_text(li.xpath('.//span[contains(@id, "_old-price")]//text()')),
        }
...
# # KW page xpathing #
###################
search_page_test_url = 'https://www.real.de/item/search/?search_value={kw}&valueKey_search_value='
...
# # PDCT page xpathing #
###################
pdct_page_test_url = 'https://www.real.de/product/321391877/?sl=Y2hhbmRvbq-Bye7HU-20a9bbTma_8Q2Mkj7TyuKkPy-1g3LLOwYb'
...
def pdct_parsing(fpath, url, products): # TODO : modify xpaths
    ...
    products[url].update({
        'pdct_img_main_url': clean_url(''.join(tree.xpath('//img/@data-src')[:1]), root_url),
    })
    print(products[url])
    return products
...
urls_ctgs_dict = {
    'champagne': 'https://www.real.de/category/6581/p{page}/',
    'sparkling': 'https://www.real.de/category/2521/p{page}/',
    'still_wines': 'https://www.real.de/category/5401/p{page}/',
    'whisky': 'https://www.real.de/category/5741/p{page}/',
    'cognac': 'https://www.real.de/weinbrand/',
    'vodka': 'https://www.real.de/category/69132/p{page}/',
    'gin': 'https://www.real.de/category/69148/p{page}/',
    'rum': 'https://www.real.de/category/69138/p{page}/',
    'brandy': 'https://www.real.de/category/69181/p{page}/',
    'red_wine': 'https://www.real.de/category/69125/p{page}/',
    'white_wine': 'https://www.real.de/category/69130/p{page}/',
}
...
kw_search_url = 'https://www.real.de/item/search/?search_value={kw}&valueKey_search_value='
for kw in keywords:
    searches[kw] = []
