...
# # CTG page xpathing #
# ##################
ctg_page_test_url = 'https://www.lavinia.es/es/paginas/100-burbujas'
...
def ctg_parsing(fpath, ctg, categories, products):  # TODO : modify xpaths
    ...
    for li in tree.xpath('//div[@class="col_sls sfull"]//div[contains(@class, "m-product expandable")]'):
        ...
        products[produrl] = {
            'pdct_name_on_eretailer': clean_xpathd_text(li.xpath('.//strong[@itemprop="name"]//text()')),
            'volume': '',
...
# # KW page xpathing #
###################
search_page_test_url = 'https://www.lavinia.es/es#/search/champagne'
...
kw_search_url = "https://sblavinia.empathybroker.com/sb-lavinia/services/search?jsonCallback=angular.callbacks._2&lang=es&q={kw}&rows=100&sort=&start=0"  # TODO : modify URL
for kw in keywords:
    searches[kw] = []
