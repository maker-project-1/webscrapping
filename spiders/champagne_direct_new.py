...
shop_id = 'champagne_direct'
root_url = 'https://www.champagnedirect.co.uk'
...
# # CTG page xpathing #
# ##################
ctg_page_test_url = 'https://www.champagnedirect.co.uk/cat_brut_nv_champagne.cfm'
...
def ctg_parsing(fpath, ctg, categories, products):  # TODO : modify xpaths
    ...
    for li in tree.xpath('//*[@itemprop="itemListElement"]'):
        if not li.xpath('.//div[@class="product_name"]/a/@href'):
            continue
        produrl = li.xpath('.//div[@class="product_name"]/a/@href')[0]
        produrl = parse_qs(urlsplit(produrl).query)['url'][0] if 'url' in parse_qs(urlsplit(produrl).query) else produrl
        products[produrl] = {
            'pdct_name_on_eretailer': clean_xpathd_text(li.xpath('.//div[@class="product_name"]/a//text()')),
            'volume': clean_xpathd_text(li.xpath('.//div[@class="product_name"]/a//text()')),
            'raw_price': clean_xpathd_text(li.xpath('.//*[@itemprop="price"]/text()')),
...
# # KW page xpathing #
###################
search_page_test_url = 'https://www.champagnedirect.co.uk/search1.cfm?Search_Term=champagne'
...
def pdct_parsing(fpath, url, products): # TODO : modify xpaths
    ...
    products[url].update({
        ...
        'pdct_img_main_url': clean_url(''.join(tree.xpath('//*[@id="product_page_pic"]//img/@src')[:1]), root_url),
        'ctg_denom_txt': ' '.join(tree.xpath('//div[contains(@class, "breadcrumbs")]//text()')),
    })
    return products
...
urls_ctgs_dict = {
    'champagne' : "https://www.champagnedirect.co.uk/cat_brut_nv_champagne.cfm",
    'whisky' : "https://www.champagnedirect.co.uk/cat_malt_whisky.cfm",
    'cognac' : "https://www.champagnedirect.co.uk/cat_brandy_cognac.cfm",
    'vodka' : "https://www.champagnedirect.co.uk/cat_vodka.cfm",
    'sparkling' : "https://www.champagnedirect.co.uk/cat_sparkling_wine.cfm",
    'still_wines' : "https://www.champagnedirect.co.uk/cat_white_wine.cfm",
    'red_wine': "https://www.champagnedirect.co.uk/cat_red_wine.cfm",
    'white_wine': "https://www.champagnedirect.co.uk/cat_white_wine.cfm",
    'rum': "https://www.champagnedirect.co.uk/cat_rum.cfm",
    'liquor': "https://www.champagnedirect.co.uk/cat_liqueurs.cfm",
}
...
kw_search_url = "https://www.champagnedirect.co.uk/search1.cfm?Search_Term={kw}"  # TODO : modify URL
for kw in keywords:
    searches[kw] = []
