...
# # CTG page xpathing #
# ##################
ctg_page_test_url = 'https://sipwhiskey.com/product-category/champagne/'
...
# # KW page xpathing #
###################
search_page_test_url = 'https://sipwhiskey.com/?s=champagne&post_type=product&type_aws=true'
...
def pdct_parsing(fpath, url, products): # TODO : modify xpaths
    ...
    products[url].update({
        ...
        'pdct_img_main_url': clean_url(''.join(tree.xpath('//img[@role="presentation"]/@src')[:1]), root_url),
