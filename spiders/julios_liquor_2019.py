...
shop_id = 'juliosliquors'
root_url = 'https://shop.juliosliquors.com/'
...
# # CTG page xpathing #
# ##################
ctg_page_test_url = 'https://shop.juliosliquors.com/main.asp?request=search&selcolor=Red&type=W'
...
def ctg_parsing(fpath, ctg, categories, products):  # TODO : modify xpaths
    ...
    for li in tree.xpath('//div[@class="product-list"]/div'):
        ...
        products[produrl] = {
            'pdct_name_on_eretailer': clean_xpathd_text(li.xpath('.//td[@valign="top"]/a/text()')),
            'volume': clean_xpathd_text(li.xpath('.//span[@class="Srch-bottlesize"]/text()')),
            'raw_price': clean_xpathd_text(li.xpath('.//span[@class="RegularPrice"]/text()')),
            'raw_promo_price': clean_xpathd_text(li.xpath('./zzzzzzzz')),
            'pdct_img_main_url': "".join(li.xpath('.//td[@valign="middle"]//@src')),
        }
...
# # KW page xpathing #
###################
search_page_test_url = 'https://shop.juliosliquors.com/main.asp?request=SEARCH&search=champagne'
...
def pdct_parsing(fpath, url, products): # TODO : modify xpaths
    ...
    products[url].update({
        'volume': clean_xpathd_text(tree.xpath('//span[@id="bmg_itemdetail_size"]//text()')),
        'pdct_img_main_url': clean_url(''.join(tree.xpath('//div[@id="loadarea"]//img/@src')[0]), root_url),
...
###################
urls_ctgs_dict = {
    'whisky': 'https://shop.juliosliquors.com/main.asp?request=TYPEPAGE&sel_category=100,130,134,140,150,160,170,190&type=L',
    'champagne': 'https://shop.juliosliquors.com/main.asp?request=TYPEPAGE&wine_type=SPARKLING&type=W',
    'cognac': 'https://shop.juliosliquors.com/main.asp?request=TYPEPAGE&sel_category=292,300&type=L',
    'sparkling': 'https://shop.juliosliquors.com/main.asp?request=TYPEPAGE&wine_type=SPARKLING&type=W',
    'vodka': 'https://shop.juliosliquors.com/main.asp?request=TYPEPAGE&sel_category=250,260&type=L',
    'still_wines': 'https://shop.juliosliquors.com/main.asp?request=search&wine_type=still&type=w&s1=s7025069538',
    'gin': 'https://shop.juliosliquors.com/main.asp?request=TYPEPAGE&sel_category=230,240&type=L',
    'tequila': 'https://shop.juliosliquors.com/main.asp?request=TYPEPAGE&sel_category=420&type=L',
    'red_wine': 'https://shop.juliosliquors.com/main.asp?request=search&selcolor=Red&type=W',
    'white_wine': 'https://shop.juliosliquors.com/main.asp?request=search&selcolor=white&type=w&s1=s5081127452',
    'rum': 'https://shop.juliosliquors.com/main.asp?request=TYPEPAGE&sel_category=310&type=L',
    'bourbon': 'https://shop.juliosliquors.com/main.asp?request=typepage&sel_category=133&type=l&s1=s2373798916',
    'brandy': 'https://shop.juliosliquors.com/main.asp?request=TYPEPAGE&sel_category=292,300&type=L',
    #'liquor': '',
}
...
kw_search_url = "https://shop.juliosliquors.com/main.asp?request=SEARCH&search={kw}"  # TODO : modify URL
for kw in keywords:
    searches[kw] = []
