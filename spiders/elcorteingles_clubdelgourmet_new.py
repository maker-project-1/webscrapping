...
shop_id = "elcorteingles_clubdelgourmet"
...
# # CTG page xpathing #
# ##################
ctg_page_test_url = 'https://www.elcorteingles.es/supermercado/bebidas/licores-y-alcoholes/?level=1'
...
def ctg_parsing(fpath, ctg, categories, products):  # TODO : modify xpaths
    ...
    for li in tree.xpath('//div[@data-scope="product"]'):
        ...
        products[produrl] = {
            ...
            'volume': clean_xpathd_text(li.xpath('./zzzzzz')),
            ...
            'pdct_img_main_url': "".join(li.xpath('./zzzzz')[:1]),
        }
        if not products[produrl]['raw_price']:
            products[produrl].update({
                'raw_price': clean_xpathd_text(li.xpath('.//span[@class="current   sale"]//text()')),
                'raw_promo_price': clean_xpathd_text(li.xpath('.//span[@class="former stroked"]//text()')),
            })
...
# # KW page xpathing #
###################
search_page_test_url = 'https://elcorteingles.es/tienda-club-del-gourmet/buscar/{page}/?term={kw}'
...
def pdct_parsing(fpath, url, products): # TODO : modify xpaths
    ...
    products[url].update({
        ...
        'pdct_img_main_url': clean_url(''.join(tree.xpath('//div[@class="pdp-media"]//img/@data-zoom-src')), root_url),
        'ctg_denom_txt': ' '.join(tree.xpath('//div[contains(@class,"breadcrumb")]//text()')),
    })
    return products
...
urls_ctgs_dict = {
    "vodka": "https://www.elcorteingles.es/tienda-club-del-gourmet/licores/destilados-y-licores/ginebra-vodka-ron-y-tequila/vodka/{page}/",
    "sparkling": "https://www.elcorteingles.es/tienda-club-del-gourmet/bodega/espumosos/espumosos-diversos/{page}/",
    "cognac": "https://www.elcorteingles.es/tienda-club-del-gourmet/licores/destilados-y-licores/brandy-conac-y-armagnac/conac-y-armagnac/{page}/",
    "champagne": "https://www.elcorteingles.es/tienda-club-del-gourmet/bodega/espumosos/champagne/{page}/",
    "still_wines": "https://www.elcorteingles.es/tienda-club-del-gourmet/bodega/vino-blanco-espana/{page}/",
    "whisky": "https://www.elcorteingles.es/tienda-club-del-gourmet/licores/destilados-y-licores/whisky/{page}/",
    "gin": "https://www.elcorteingles.es/tienda-club-del-gourmet/licores/destilados-y-licores/ginebra-vodka-ron-y-tequila/ginebra/{page}/",
    "tequila": "https://www.elcorteingles.es/tienda-club-del-gourmet/licores/destilados-y-licores/ginebra-vodka-ron-y-tequila/tequila/{page}/",
    "rum": "https://www.elcorteingles.es/tienda-club-del-gourmet/licores/destilados-y-licores/ginebra-vodka-ron-y-tequila/ron/{page}/",
    "red_wine": "https://www.elcorteingles.es/tienda-club-del-gourmet/bodega/vino-blanco-de-francia/{page}/",
    "white_wine": "https://www.elcorteingles.es/tienda-club-del-gourmet/bodega/vino-tinto-de-francia/{page}/",
    "liquor": "https://www.elcorteingles.es/tienda-club-del-gourmet/licores/destilados-y-licores/licores-y-cremas/{page}/"
}
...
kw_search_url = "https://elcorteingles.es/tienda-club-del-gourmet/buscar/{page}/?term={kw}"  # TODO : modify URL
for kw in keywords:
    searches[kw] = []
