...
shop_id = 'decantalo'
root_url = 'https://www.decantalo.com'
...
# # CTG page xpathing #
# ##################
ctg_page_test_url = 'https://www.decantalo.com/es/vino/'
...
# # KW page xpathing #
###################
search_page_test_url = 'https://www.decantalo.com/es/buscar?controller=search&orderby=id_product&orderway=desc&search_query=champagne&submit_search=Buscar'
...
urls_ctgs_dict = {
    'whisky': 'https://www.decantalo.com/fr/spiritueux/whisky/?p={page}',
    'champagne': 'https://www.decantalo.com/fr/vins-mousseux/champagne/?p={page}',
    'cognac': 'https://www.decantalo.com/fr/spiritueux/cognac/?p={page}',
    'sparkling': 'https://www.decantalo.com/fr/vins-mousseux/?p={page}',
    'vodka': 'https://www.decantalo.com/fr/spiritueux/vodka/?p={page}',
    'still_wines': 'https://www.decantalo.com/fr/vin/?p={page}',
    'gin': 'https://www.decantalo.com/fr/spiritueux/gin/?p={page}',
    'tequila': 'https://www.decantalo.com/fr/spiritueux/tequila-mescal/?p={page}',
    'red_wine': 'https://www.decantalo.com/fr/vin/rouge/?p={page}',
    'white_wine': 'https://www.decantalo.com/fr/vin/blanc/?p={page}',
    'rum': 'https://www.decantalo.com/fr/spiritueux/rhum/?p={page}',
    'bourbon': 'https://www.decantalo.com/fr/spiritueux/whisky/?p={page}',
    'brandy': 'https://www.decantalo.com/fr/spiritueux/brandy/?p={page}',
    'liquor': 'https://www.decantalo.com/fr/spiritueux/liqueurs/?p={page}'
}
...
kw_search_url = "https://www.decantalo.com/es/buscar?controller=search&orderby=id_product&orderway=desc&search_query={kw}&submit_search=Buscar&p={page}"  # TODO : modify URL
for kw in keywords:
    searches[kw] = []
