...
# # CTG page xpathing #
# ##################
ctg_page_test_url = 'https://www.b-21.com/searchwine.asp'
...
def ctg_parsing(fpath, ctg, categories, products):  # TODO : modify xpaths
    ...
    for li in tree.xpath('//div[contains(@class, "c data2")]/table[3]/tbody/tr'):
        if not li.xpath('.//*[contains(@class, "prodstitle")]/@href'):
            continue
        produrl = li.xpath('.//*[contains(@class, "prodstitle")]/@href')[0]
        produrl = parse_qs(urlsplit(produrl).query)['url'][0] if 'url' in parse_qs(urlsplit(produrl).query) else produrl
        products[produrl] = {
            'pdct_name_on_eretailer': clean_xpathd_text(li.xpath('.//*[contains(@class, "prodstitle")]/@title')),
            'volume': clean_xpathd_text(li.xpath('.//*[contains(@class, "prodstitle")]/@title')),
            'raw_price': clean_xpathd_text(li.xpath('.//span[contains(@class, "prodsprice")]/text()')),
            'raw_promo_price': clean_xpathd_text(li.xpath('.//span[contains(@class, "prodsprice")]/s/text()')),
...
# # KW page xpathing #
###################
search_page_test_url = 'https://www.b-21.com/searchprods.asp'
...
kw_search_url = "https://www.b-21.com/searchprods.asp?searchstring={kw}&pagenumber={page}&val=0"  # TODO : modify URL
for kw in keywords:
    searches[kw] = []
