...
shop_id = "enoteca"
root_url = "https://www.enoteca.co.jp"
country = "JP"
...
exple_ctg_page_path = op.join(TEST_PAGES_FOLDER_PATH, "enoteca", 'ctg_page_test.html') # TODO : store the file
...
def ctg_parsing(fpath, ctg, categories, products):  # TODO : modify xpaths
    ...
    for li in tree.xpath('//section[@class="item-list"]/div[@class="item"]'):
        ...
        products[produrl] = {
            'pdct_name_on_eretailer': clean_xpathd_text(li.xpath('.//div[@class="product-ttl"]/a//text()'), unicodedata_normalize=True),
            'raw_price': clean_xpathd_text(li.xpath('.//div[@class="product-price"]//span[@class="price-original"]//text()'), unicodedata_normalize=True),
            'raw_promo_price': clean_xpathd_text(li.xpath('(.//div[@class="product-price"]//div[@class="price-sale"]/span/text())[1]'), unicodedata_normalize=True),
...
exple_kw_page_path = op.join(TEST_PAGES_FOLDER_PATH, "enoteca", 'kw_page_test.html') # TODO : store the file
...
urls_ctgs_dict = {
    'champagne': 'https://www.enoteca.co.jp/item/list?page={page}&_area=3001&_qty=1#list',
    'sparkling': 'https://www.enoteca.co.jp/item/list?page={page}&_sp=asc&_color=5&_size=750&_qty=1#list',
    'still_wines': 'https://www.enoteca.co.jp/item/list?page={page}&_ctg=1',
    # 'whisky': '',#na
    # 'cognac': '',#na
    # 'vodka': '',#na
    # 'gin': '',#na
...
kw_search_url = "https://www.enoteca.co.jp/item/list?&_searchtype=2&_word={kw}"  # TODO : modify URL
for kw in keywords:
    searches[kw] = []
