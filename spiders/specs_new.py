...
urls_ctgs_dict = {
    'champagne': 'https://specsonline.com/product-category/wine/page/{page}/?filter_wine-category=champagne',
    'sparkling': 'https://specsonline.com/product-category/wine/page/{page}/?filter_wine-category=other-french-sparkling-wines',
    'still_wines': 'https://specsonline.com/product-category/wine/page/{page}',
    'whisky': 'https://specsonline.com/product-category/spirits/page/{page}/?filter_spirits-category=scotch-malts',
    'cognac': 'https://specsonline.com/product-category/spirits/page/{page}/?filter_spirits-category=cognac',
    'vodka': 'https://specsonline.com/product-category/spirits/page/{page}/?filter_spirits-category=imported-vodka',
    'red_wine': 'https://specsonline.com/page/{page}/?s=red+wine&post_type=product&product_cat=wine',
    'white_wine': 'https://specsonline.com/page/{page}/?s=white+wine&post_type=product&product_cat=wine',
    'gin': 'https://specsonline.com/product-category/spirits/page/{page}/?query_type_spirits-category=or&filter_spirits-category=gin',
    'rum': 'https://specsonline.com/product-category/spirits/page/{page}/?query_type_spirits-category=or&filter_spirits-category=rum',
    'tequila': 'https://specsonline.com/product-category/spirits/page/{page}/?query_type_spirits-category=or&filter_spirits-category=tequila',
    'brandy': 'https://specsonline.com/product-category/spirits/page/{page}/?query_type_spirits-category=or&filter_spirits-category=brandy',
    'liquor': 'https://specsonline.com/product-category/spirits/page/{page}/?query_type_spirits-category=or&filter_spirits-category=liquor',
}
...
kw_search_url = "https://specsonline.com/?s={kw}&post_type=product"  # TODO : modify URL
for kw in keywords:
    searches[kw] = []
